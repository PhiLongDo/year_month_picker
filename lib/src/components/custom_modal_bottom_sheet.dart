...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  ...
  void handleDragEnd(DragEndDetails details, {bool? isClosing}) {
    ...
    animationCurve =
        Split(widget.route.animation!.value, endCurve: _modalBottomSheetCurve);
  }
...
class CustomModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  /// bottom sheet.
  ///
  /// Consider setting this attribute when the [CustomModalBottomSheetRoute]
  ...
  /// the barrier for this [CustomModalBottomSheetRoute] should be clipped.
  ///
